...
## Project details
The aim of the competition is simple. Given what we know about a passenger aboard the Titanic, can we predict whether or not this passenger has survive? In other words, we
